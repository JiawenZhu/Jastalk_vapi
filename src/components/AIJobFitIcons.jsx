...
export const AcademicCapIcon = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0l-.07.004-.002.001-.002.001-.001.001M21.74 10.147l-.07-.004-.002-.001-.002-.001-.001-.001m-15.482 0A50.697 50.697 0 0112 13.489a50.702 50.702 0 017.74-3.342M6.26 6.178L12 10.489l5.74-4.311M12 16.511l-5.74-4.311" />
    </svg>
);
...
export const ClipboardIcon = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.666 3.888A2.25 2.25 0 0013.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v3.042c0 .317-.126.623-.352.848l-1.636 1.636a.75.75 0 01-1.06 0l-1.636-1.636a1.125 1.125 0 01-.352-.848V5.378c0-.212.03-.418.084-.612m7.332 0c.646.049 1.288.11 1.927.184 1.1.128 1.907 1.077 1.907 2.185v1.266c0 1.108-.806 2.057-1.907 2.185A48.217 48.217 0 0112 13.5c-2.405 0-4.773-.293-7.073-.842A2.25 2.25 0 013.75 10.51V9.243c0-1.108.806-2.057 1.907-2.185A48.217 48.217 0 0112 6.5c2.405 0 4.773.293 7.073.842 1.1.128 1.907 1.077 1.907 2.185v1.266c0 1.108-.806 2.057-1.907 2.185A48.217 48.217 0 0112 13.5c-2.405 0-4.773-.293-7.073-.842A2.25 2.25 0 013.75 10.51V9.243c0-1.108.806-2.057 1.907-2.185A48.217 48.217 0 0112 6.5c2.405 0 4.773.293 7.073.842z" />
    </svg>
);
